                ...
                <div className="text-center">
                  <div className="relative inline-block mb-6">
                    <img
                      src={member.image}
                      alt={member.name}
                      className="w-56 h-56 rounded-full object-contain mx-auto border-4 border-[#00C853] bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-800 dark:to-gray-900"
                    />
